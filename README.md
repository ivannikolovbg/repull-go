...
> **Status:** v0.2.11 — alpha. `pkg.go.dev` listing pending (auto-publishes on
> first import).

## Install

```bash
go get github.com/ivannikolovbg/repull-go@v0.2.11
```
...
v0.2.11 — alpha. The API surface tracks `https://api.repull.dev/api/repull/openapi.json`
